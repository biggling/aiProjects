...
cp "$SCRIPT_DIR/CLAUDE-decisions.md" "$MEMORY_DIR/CLAUDE-decisions.md"

echo ""
echo "✓ Created memory-bank/ with 5 files:"
echo "  memory-bank/projectBrief.md      — your stack, goals, non-negotiable rules"
echo "  memory-bank/activeContext.md     — what's in progress right now"
echo "  memory-bank/progress.md          — done / blocked / next"
echo "  memory-bank/systemPatterns.md    — naming conventions + gotchas"
echo "  memory-bank/CLAUDE-decisions.md  — architecture decisions + rejected approaches"
echo ""
echo "Next steps:"
echo ""
...
echo "   When you make an architecture decision, append it to memory-bank/CLAUDE-decisions.md."
